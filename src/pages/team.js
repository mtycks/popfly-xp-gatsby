...
const OurTeamPage = () => {
  ...
  const team = [
    ...
    {name: "Luis Zuno", img: data.luis.childImageSharp.fluid, title: "Founder & CMO", desc: "Luis is a well versed and highly experienced marketing executive who is leading our experience and operations teams to create a great experience and connectivity with our partners, clients and fans." },
